package c.santander.dev.week3.service.impl;

import c.santander.dev.week3.domain.model.User;
import c.santander.dev.week3.domain.repository.UserRepository;
import c.santander.dev.week3.service.UserService;
import c.santander.dev.week3.service.exception.BusinessException;
import c.santander.dev.week3.service.exception.NotFoundException;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User findById(Event.ID id) {
        return null;
    }
    ...
    public User create(User userToCreate) {
        ...
        if (userRepository.existsByIdAccountNumber(userToCreate.getAccount().getNumber())) {
    ...
    @Override
    public User update(Event.ID id, User entity) {
        return null;
    }

    @Override
    public void delete(Event.ID id) {
